...
class ModeloFuenteOficial(BaseModel):
    ...
    proves_campaign: bool = Field(default=False, description="Si esta fuente prueba directamente la campana")
    campaign_evidence_role: str = Field(default="none", description="Rol probatorio de campana: none, weak, strong o conflict")
...
class ModeloArtefacto(BaseModel):
    ...
    nota: str | None = Field(default=None, description="Nota descriptiva")
    proves_campaign: bool = Field(default=False, description="Si este artefacto prueba directamente la campana")
    campaign_evidence_role: str = Field(default="none", description="Rol probatorio de campana: none, weak, strong o conflict")
...
class DocInterpretativoListItem(BaseModel):
    ...
    verified: bool | None = Field(default=None, description="True solo si hay texto oficial CNMV parseable y trazable")
    completeness: str | None = Field(default=None, description="complete | partial")
    row_completeness: str | None = Field(default=None, description="complete | partial")
    row_provenance: str | None = Field(default=None, description="official_exact | official_best_effort")
