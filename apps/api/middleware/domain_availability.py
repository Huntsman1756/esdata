...
DOMAIN_PATH_TABLE_MAP: list[tuple[str, str, str, str]] = [
    ...
    ("/v1/sfdr/pacai-indicators", "sfdr_paci_indicator", "SFDR", "public"),
    ...
    ("/v1/pbc/suspicious-reports", "suspicious_activity_report", "PBC/AML", "operational"),
    ...
    ("/v1/aifmd/funds", "aifmd_fund", "AIFMD", "public"),
    ("/v1/aifmd/regulatory-reports", "aifmd_regulatory_report", "AIFMD", "public"),
    ("/v1/aifmd/liquidity-management", "aifmd_liquidity_management", "AIFMD", "operational"),
    ("/v1/ucits/funds", "ucits_fund", "UCITS", "public"),
    ("/v1/ucits/regulatory-reports", "ucits_regulatory_report", "UCITS", "public"),
    ("/v1/crd/capital-positions", "crd_capital_position", "CRD/CRR", "operational"),
    ("/v1/crd/stress-tests", "crd_stress_test", "CRD/CRR", "operational"),
    ("/v1/crd/bail-in", "brrd_bail_in", "BRRD", "operational"),
    ("/v1/emir/trade-reports", "emir_trade_report", "EMIR", "operational"),
    ("/v1/emir/clearing-members", "emir_clearing_member", "EMIR", "operational"),
    ("/v1/consumer-credit/contracts", "consumer_credit_contract", "Consumer Credit", "operational"),
    ("/v1/consumer-credit/disclosures", "consumer_credit_disclosure", "Consumer Credit", "operational"),
    ("/v1/consumer-credit/overindebtedness", "consumer_credit_overindebtedness", "Consumer Credit", "operational"),
    ("/v1/insurance/distributors", "idd_distributor", "IDD", "operational"),
    ("/v1/insurance/uci-products", "idd_product_uci", "IDD", "operational"),
    ("/v1/insurance/solvency-entities", "solvency_ii_entity", "Solvency II", "operational"),
    ("/v1/insurance/solvency-sfp", "solvency_ii_sfp", "Solvency II", "operational"),
    ("/v1/transparency/issuers", "transparency_issuer", "Transparency", "public"),
    ("/v1/transparency/regulated-info", "transparency_regulated_information", "Transparency", "public"),
    ("/v1/transparency/voting-rights", "transparency_voting_rights", "Transparency", "public"),
    ("/v1/transparency/internal-rules", "transparency_internal_rule", "Transparency", "operational"),
    ("/v1/xbrl/facts", "xbrl_fact", "XBRL", "public"),
    ("/v1/xbrl/enriched-facts", "xbrl_fact", "XBRL", "public"),
]
