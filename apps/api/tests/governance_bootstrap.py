"""Test-only SQLite bootstrap for governance persistence tables."""
...
DDL_TEMPLATE = [
    ...
    """
    CREATE TABLE source_freshness_snapshot (
        id {id_column},
...
def ddl_statements_for_dialect(dialect: str) -> list[str]:
...
def bootstrap_governance_tables(engine, dialect: str = "sqlite") -> None:
    with engine.begin() as conn:
        for statement in ddl_statements_for_dialect(dialect):
