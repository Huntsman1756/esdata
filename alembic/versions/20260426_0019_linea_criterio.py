...
def upgrade():
    op.create_table(
        ...
        sa.Column("estado", sa.Text(), nullable=False, default="borrador"),
        ...
        sa.Index("ix_linea_criterio_titulo_trgm", "titulo", postgresql_ops={"titulo": "gin_trgm_ops"}),
    )
    ...
    op.execute("""
        INSERT INTO linea_criterio (titulo, cuestion_practica, descripcion, criterio_dominante, matices, excepciones, estado, autor_id, revisor_id) VALUES
