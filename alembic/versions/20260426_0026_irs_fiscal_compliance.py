...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('tipo', sa.Text(), nullable=False, server_default=sa.text("'publicacion'::text")),
    ...
    op.create_table(
        ...
        sa.Column('tipo_acuerdo', sa.Text(), nullable=False, server_default=sa.text("'bilateral'::text")),
        ...
        sa.Column('estado', sa.Text(), nullable=False, server_default=sa.text("'vigente'::text")),
        sa.Column('creado_en', sa.DateTime(), server_default=sa.text("NOW()")),
        sa.Column('actualizado_en', sa.DateTime(), server_default=sa.text("NOW()")),
    )
    ...
    op.create_table(
        ...
        sa.Column('tipo_retencion_default', sa.Float(), nullable=False, server_default=sa.text("30.0")),
    ...
    op.create_table(
        ...
        sa.Column('descripcion', sa.Text(), nullable=True),
        sa.Column('tipo_sujeto', sa.Text(), nullable=False, server_default=sa.text("'persona_fisica'::text")),
        sa.Column('finalidad', sa.Text(), nullable=True),
        sa.Column('partes', JSONB, nullable=True),
        sa.Column('validez_anios', sa.Integer(), nullable=False, server_default=sa.text("3")),
    ...
    op.create_table(
        ...
        sa.Column('es_ocde', sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column('es_eu_vat', sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column('creado_en', sa.DateTime(), server_default=sa.text("NOW()")),
    )
    ...
    op.create_table(
        ...
        sa.Column('estado_fatca', sa.Text(), nullable=False, server_default=sa.text("'activo'::text")),
        sa.Column('fecha_registro', sa.Date(), nullable=True),
        sa.Column('fecha_expiracion', sa.Date(), nullable=True),
        sa.Column('es_exempt_beneficial_owner', sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column('es_sponsored_ffo', sa.Boolean(), nullable=False, server_default=sa.text("false")),
