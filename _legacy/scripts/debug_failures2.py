...
queries = [
    ("Retenciones ingresos a cuenta modelo 111", "irpf-002"),
    ("Retenciones arrendamientos urbanos modelo 115", "irpf-003"),
...
for q, qid in queries:
    ...
    for m in modelos[:3]:
        ...
        cat = m.get("categoria_obligado", "?")
        print(f"    modelo {codigo}: norma_base={nb}, cat={cat}")
