...
| 290 | Modelo 290. FATCA. Cuentas financieras de determinadas personas estadounidenses. | https://sede.agenciatributaria.gob.es/static_files/Sede/Procedimiento_ayuda/GI38/Ayuda/XSD_WSDL/290_XSD_2.0_WSDL_2.1.1.zip | ZIP with WSDL/XSD | STATUS-A | M-03 localizo ZIP oficial FATCA; parser carga 152 campos XML oficiales. Revision 2026-05-25: la documentacion vigente GI38 queda asociada a campana `2025` para el plazo 2026 de informacion financiera del ano inmediato anterior; el ano 2013 del Acuerdo FATCA es historico/normativo, no campana activa. |
...
M-07: el modelo `290` ya no depende del fallback de 6 campos; carga 152 campos XSD oficiales de FATCA. Revision 2026-05-25: el contrato documental del modelo se mantiene sobre la campana `2025` con GI38 actual, XSD 2.0/WSDL 2.1.1, manual tecnico 2.16, FAQ, plazos y consulta de errores. Esto no promueve por si solo `obligacion_perfil.safe_to_answer=true`: la aplicabilidad por perfil sigue requiriendo evidencia normalizada propia.
