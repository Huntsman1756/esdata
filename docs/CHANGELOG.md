...
### main
- **PENDING** `docs(roadmap)` — add explicit multi-machine reentry steps for `main` and `wip/mica-2026-04-27` so the next session can resume safely from another computer without relying on local context
