...
| 290 | ZIP XSD/WSDL + manual tecnico PDF | https://sede.agenciatributaria.gob.es/Sede/todas-gestiones/impuestos-tasas/declaraciones-informativas/modelo-290-decla_____s-determinadas-personas-fatca_/informacion-sobre-presentacion-mediante-web-service.html | STATUS-A | Fuente oficial FATCA con XSD 2.0/WSDL 2.1.1 y manual tecnico 2.16. Revision 2026-05-25: la campana documental activa debe ser `2025` porque el plazo AEAT vigente es 01/01/2026-01/06/2026 para la informacion financiera del ano inmediato anterior; no usar el ano historico 2013 del Acuerdo FATCA como campana activa. Las fuentes de referencia FATCA enlazadas desde GI38 se registran explicitamente: Validaciones TIN, Acuerdo de autoridades competentes, ficha GI38 y normativa BOE `BOE-A-2014-6854`, `BOE-A-2014-6922`, `BOE-A-2015-2629`, `BOE-A-2015-14021`, `BOE-A-2016-9834`. |
