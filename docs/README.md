...
- `source-closeout-audit-20260531.md` — auditoria amplia de fuentes, superficies y gaps de cierre
- `source-assurance-certification-20260531.md` — certificacion anti-overclaim: que dominios estan cargados, parciales, limitados o no certificados
