...
| D-04 CRS/FATCA | `complete` | DGT `V0138-24` | Migracion `20260523_0087_doctrina_d04_crs_fatca`: `LGT art. vigésimo segunda`, `289`, `crs_fatca` | Si: `289` ligado al supuesto CRS/FATCA en relacion `modelo_supuesto` | Si: `historico_a_fecha_consulta` | Completa solo para CRS/FATCA/modelo 289; no usar como procedimiento completo de reporte |
...
2. No persistir D-05..D-09 hasta tener anclaje real por articulo/modelo/supuesto.
