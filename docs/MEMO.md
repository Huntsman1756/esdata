...
| xxxxxxxx | feat(api) | Fase 31.1: MiCA/crypto data model — migration 0036 (5 tablas), 25 schemas Pydantic, 10 endpoints /v1/mica | alembic/versions/20260427_0036_mica_crypto_models.py, apps/api/schemas.py, apps/api/routers/mica.py, apps/api/main.py, docs/CHANGELOG.md, docs/MEMO.md |
