...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| AEAT | Modelos fiscales | `implemented_partial` | Sede AEAT, recursos oficiales de modelos | 219 modelos y 31.685 casillas en baseline A-14; closeout prioritario: 6 `complete`, 9 `partial`, 8 `target`; familia capital mobiliario `123/124/193` con routing semantico documentado y reglas condicionales para `123/124` | si | si | Mixta: varios modelos con `verified` y fuentes oficiales; estado por modelo en `docs/aeat-priority-model-closeout.md` y `docs/aeat-capital-mobiliario-123-124-193-routing.md` | si | AEAT no esta cerrado como bloque unico; quedan modelos parciales y target; `124` sigue parcial y condicionado a operacion especifica de activos financieros; `123/124` no tienen claves/instrucciones deterministicas completas | Ejecutar PRDs derivados para 100/200/202/289/303 o completar claves/instrucciones oficiales de `123/124` si existe fuente determinista |
