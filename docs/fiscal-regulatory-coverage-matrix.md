...
| Doctrina administrativa | Lineas de criterio DGT/TEAC | `implemented_partial` | DGT/PETETE, Hacienda/TEAC DYCTEA | Auditoria/despliegue 2026-05-21, matriz operativa 2026-05-22 y curacion D-02 2026-05-23: corpus existe; VPS expone D-01..D-09; `/v1/doctrina/lineas/coverage` devuelve `lineas_total=16`, `lineas_complete=1` antes de 0086; migracion 0085 persiste relaciones parciales D-03/D-04 y 0086 cierra D-02 con DGT `V0963-25` cuando se despliegue | parcial | parcial | Parcial: contrato proyecta URL/hash/capture date desde `source_revision`; D-01 queda `complete`; D-02 queda acotada a adquisicion intracomunitaria de bienes (`LIVA art. 13`, modelo 349) tras 0086; D-03 queda parcial con `LIS art. 18` persistido; D-04 conserva 289 parcial persistido; las demas lineas no exponen articulo/modelo si el supuesto no esta probado | si | D-03..D-09 siguen sin cierre completo; TEAC en D-01 queda soporte parcial, no cierre propio; D-02 no cubre entregas intracomunitarias ni IVA generico | Desplegar/validar 0086, cerrar vigencia/modelo en D-03/D-04/D-06 y usar `docs/doctrina-operational-coverage-matrix.md` como matriz viva |
