...
| Doctrina administrativa | Lineas de criterio DGT/TEAC | `implemented_partial` | DGT/PETETE, Hacienda/TEAC DYCTEA | Auditoria/despliegue 2026-05-21: corpus existe; VPS expone D-01..D-09; `/v1/doctrina/lineas/coverage` devuelve `lineas_total=16`, `lineas_complete=1`, `lineas_con_articulo=2` | parcial | parcial | Parcial: contrato VPS proyecta URL/hash/capture date desde `source_revision`; D-01 queda `complete`; D-03 queda parcial con `LIS art. 18`; D-04 conserva 289 parcial; las demas lineas no exponen articulo/modelo si el supuesto no esta probado | si | D-02..D-09 siguen sin cierre completo; TEAC en D-01 queda soporte parcial, no cierre propio | Buscar fuentes principales mejores para D-02/D-07/D-09 y cerrar vigencia/modelo en D-03/D-04/D-06 antes de completar |
