...
- 2026-05-19 23:05 Europe/Madrid - `[EN CURSO]` Sprint N MiCA emisor_token en rama `feat/sprint-n-emisor-token`. Alcance: crear perfil `emisor_token`, cargar obligaciones base MiCA ART/EMT arts. 18, 19, 25, 35, 45, 48, 51 y 55 contra `32023R1114`, documentar gap de corpus supervisor ART/EMT, actualizar routing MCP y suites. Regla: no crear nuevos RTS ni documentos BdE/CNMV inventados; corpus ART/EMT supervisor se trata como gap explícito. VPS objetivo confirmado: `root@212.227.227.64`, repo `/srv/esdata`.
