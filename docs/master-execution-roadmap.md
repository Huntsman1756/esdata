...
- 2026-05-17 20:10 Europe/Madrid - `[COMPLETADO LOCAL + VPS]` Sprint F evidence_limited coverage en rama `feat/sprint-f-evidence-limited`. Produccion: `obligacion_perfil=132`, `verified=132`, `evidence_limited=0`; perfiles al 100%: `sociedad_valores=28/28`, `agencia_valores=26/26`, `sgiic=21/21`, `eaf=20/20`, `entidad_credito=27/27`, `empresa_servicios_pago=10/10`. Correcciones principales: IFR/IFD cargadas (`32019R2033`, `32019L2034`), ESI prudencial a IFR art. 11, LIVMC conduct actualizado a articulos vigentes, Modelos 187/198/289/290 con base legal confirmada, SGIIC Annex IV deduplicado y ESP PBC/FT a `LEY10_2010 art. 2.1.h`. Informe: `docs/sprint-f-coverage-report.md`. Siguiente paso exacto: F-12 actualizar suites MCP y F-13 verificacion final antes de push.
