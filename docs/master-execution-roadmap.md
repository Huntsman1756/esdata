...
- 2026-05-18 23:05 Europe/Madrid - `[EN CURSO]` Sprint J CRS/Modelo 289 en rama `feat/sprint-j-crs-289`. J-01 a J-04 completados. Esquema productivo documentado en `docs/schema-modelo-tables.md`: Modelo 289 `aeat_modelo.id=95`, `modelo_campana.id=95`. Normativa 289 queda en `4` filas. Instrucciones 289 queda en `5` filas. Reglas CRS/289 queda en `6` filas para `campana_id=95`, con decisiones reales del enum productivo (`INCLUIR`/`EXCLUIR`): custodia, deposito e inversion incluidas; entidad gubernamental/banco central, NFE activa y cuenta preexistente bajo umbral 250.000 USD excluidas. Verificacion J-04: `Reglas inclusion 289: 6`, `Reglas exclusion 289: 3`, `PASS`. Siguiente paso exacto: J-05 cargar keywords CRS/289 en `modelo_trigger_keyword` usando `modelo_id=95`.
