...
- 2026-05-31 - `[EN CURSO LOCAL]` `P1-MAINTENANCE-CLOSEOUT-01`: cerrar P1 tras auditoria exhaustiva sin abrir v2. Alcance: programar `mcp_deep_contract_audit.py` como timer systemd recurrente, reforzar documentacion de mantenimiento/freeze v1, crear tag de release funcional y desplegar/verificar en VPS. Backup/offsite restore sigue fuera por decision previa del usuario y queda como P0 diferido separado.
