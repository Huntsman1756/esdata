...
- 2026-06-04 - `[PENDIENTE]` `ESMA-MIFIR-TR-NAV-FIELD-GUIDE-0121`: preparar, cuando exista adopcion formal por Comision y publicacion DOUE del RTS 22/24 revisado, un contrato/field guide TR para instrumentos con precio basado en NAV: campo 33 `Price`, `PNDG` cuando el precio no esta disponible al momento de ejecucion, cancelacion/amendment posterior con precio efectivo, consistencia con cantidad/campo 30 y separacion entre RTS 22 vigente (`Reglamento Delegado 2017/590`) y texto revisado adoptado. No sembrar antes como vigente ni mezclar con la regla FCR/AIF; requiere fuente oficial adoptada y pruebas MCP/API antes de deploy.
