...
- 2026-05-31 - `[EN CURSO LOCAL]` `P0.5-SOURCE-ASSURANCE-01`: auditoria de aseguramiento de fuentes para bloquear sobreclaims catastroficos. Alcance: demostrar que ningun dominio se certifica como exhaustivo, endurecer OpenAPI/manual contra lenguaje tipo `all/full/complete`, crear `docs/source-assurance-certification-20260531.md`, anadir gate `scripts/maintenance/source_assurance_gate.py`, y desplegar/verificar en VPS junto a `final_product_acceptance_gate`, `mcp_validation_suite` y `mcp_deep_contract_audit`.
