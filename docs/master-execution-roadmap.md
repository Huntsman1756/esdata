...
- 2026-05-18 22:50 Europe/Madrid - `[EN CURSO]` Sprint J CRS/Modelo 289 en rama `feat/sprint-j-crs-289`. J-01/J-02/J-03 completados. Esquema productivo documentado en `docs/schema-modelo-tables.md`: Modelo 289 `aeat_modelo.id=95`, `modelo_campana.id=95`. Normativa 289 queda en `4` filas (`RD 1021/2015`, `LGT DA 22`, `DAC2`, Orden HAC/1150/2024). J-03 cargo 5 instrucciones en `modelo_instruccion` para `campana_id=95`: IFO, cuenta reportable, plazo enero-mayo, declaracion negativa NilReport/CRS704 y correcciones CRS701/CRS702/CRS703. Verificacion J-03: `Instrucciones 289: 5`, `PASS`. Siguiente paso exacto: J-04 cargar reglas CRS de inclusion/exclusion en `modelo_regla_inclusion`.
