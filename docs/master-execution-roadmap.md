...
- 2026-05-18 20:35 Europe/Madrid - `[EN CURSO LOCAL]` Sprint I RTS 1/RTS 2 MiFIR en rama `feat/sprint-i-rts1-rts2`. I-01..I-04 completados. Docker Desktop reparado por ACL de VM en `D:\Docker\DockerDesktopWSL\main\ext4.vhdx`. RTS 1 `32017R0587`, RTS 2 `32017R0583` y prerequisito local MiFIR `32014R0600` cargados en `norma`. Obligaciones RTS 1/2 condicionadas SI cargadas en `sociedad_valores`, `agencia_valores` y `entidad_credito`; notas de pre-negociacion enriquecidas con waivers RTS 1 art. 9.1.a-d y RTS 2 art. 9.1.a-c. Verificaciones: I-01 `PASS`, I-02 `PASS`, I-03 `PASS`, I-04 `Rows with waiver notes: 12 PASS`. Caveat: DB local `deploy` estaba vacia antes del sprint; siguiente paso exacto: I-05, registrar o documentar fuente soporte ESMA SI register.
