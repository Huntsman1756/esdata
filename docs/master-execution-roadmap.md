...
- 2026-05-27 - `[EN CURSO]` `HERMES-AEAT-EVIDENCE-ADMISSION-01`: crear gate explicito para decidir si los JSON validados de Hermes son admisibles como evidencia documental revisable. Alcance: script read-only `audit_aeat_hermes_integration.py`, tests focales, documentacion de contrato y prueba contra informes reales del VPS para `210`, `128` y `113` si existen. Regla: `integrable=true` no promueve campana ni escribe datos; solo significa que hay claims oficiales trazables para revision humana.
