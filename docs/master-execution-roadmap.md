...
- 2026-05-18 22:35 Europe/Madrid - `[EN CURSO]` Sprint J CRS/Modelo 289 en rama `feat/sprint-j-crs-289`. J-01/J-02 completados. J-01 inspecciono esquema productivo de tablas `modelo_*` en VPS y dejo `docs/schema-modelo-tables.md` como fuente de verdad: Modelo 289 `aeat_modelo.id=95`, `modelo_campana.id=95`, campana `2025`; `modelo_normativa` y `modelo_trigger_keyword` se enlazan por `modelo_id`; `modelo_instruccion`, `modelo_regla_inclusion`, `modelo_casilla` y `modelo_recurso` por `campana_id`. J-02 cargo en VPS tres fuentes oficiales adicionales en `modelo_normativa` para `modelo_id=95`: RD 1021/2015 `BOE-A-2015-12399`, LGT DA 22 `BOE-A-2003-23186` y DAC2 `CELEX:32014L0107`; junto a la Orden HAC/1150/2024 existente, `Normativa 289: 4`, `PASS`. Siguiente paso exacto: J-03 cargar instrucciones CRS/289 en `modelo_instruccion` usando `campana_id=95`.
