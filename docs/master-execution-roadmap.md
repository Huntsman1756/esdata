...
- 2026-06-01 - `[EN CURSO]` `AEAT-190-123-124-289-FOCUS-01`: foco solicitado por el usuario en modelos AEAT `190`, `123`, `124` y `289`. Alcance: diagnostico VPS real, checks read-only de evidencia parcial/trazable y contratos API fail-closed de campana; no poblar seeds ni promocionar campanas/obligaciones sin evidencia oficial directa. Archivos reclamados: `scripts/maintenance/mcp_validation_suite.py`, `scripts/tests/test_maintenance_agents.py`, `docs/master-execution-roadmap.md`.
