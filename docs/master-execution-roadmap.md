...
- 2026-05-18 20:32 Europe/Madrid - `[EN CURSO LOCAL]` Sprint I RTS 1/RTS 2 MiFIR en rama `feat/sprint-i-rts1-rts2`. I-01 e I-02 completados. Docker Desktop reparado tras diagnosticar `Wsl/Service/CreateInstance/MountDisk/HCS/E_ACCESSDENIED` en `D:\Docker\DockerDesktopWSL\main\ext4.vhdx` y corregir ACL de VM. RTS 1 `32017R0587`, RTS 2 `32017R0583` y prerequisito local MiFIR `32014R0600` cargados en `norma`. `sociedad_valores` tiene 4 obligaciones RTS 1/2 condicionadas a SI (`verified=true`, `completeness=parcial`, `source_url` EUR-Lex) mas politica SI MiFIR art. 13. Verificaciones: I-01 `RTS 1+2: 2 PASS`; I-02 `SV RTS1/2: 4 PASS`. Caveat: DB local `deploy` estaba vacia antes del sprint; siguiente paso exacto: I-03, cargar obligaciones equivalentes para `agencia_valores` y `entidad_credito`, sin tocar perfiles excluidos.
