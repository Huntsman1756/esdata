...
- 2026-06-01 - `[EN CURSO]` `AEAT-MODELO-289-CAMPAIGN-DUALITY-01`: resolver el conflicto semantico del modelo `289` separando `ejercicio_declarado` y `anio_presentacion`, corrigiendo la URL AEAT 2025 en seeds/datos productivos y verificando en VPS que `campana_conflict_evidence` queda limpio sin promover obligaciones por perfil.
