...
- 2026-05-19 20:20 Europe/Madrid - `[EN CURSO]` Sprint M MiCA CASP en rama `feat/sprint-m-mica-casp`. Alcance: materializar PRD Sprint M, limpiar norma debil `MICA_2023_1114` hacia `32023R1114`, crear perfil `casp`, cargar obligaciones base CASP, verificar/cargar RTS MiCA CASP confirmados, y endurecer routing MCP fail-closed para cripto. `emisor_token` queda explicitamente diferido a Sprint N.
