...
- 2026-06-01 - `[EN CURSO]` `AEAT-MODELO-123-CAMPAIGN-EVIDENCE-01`: cerrar el gap simple del modelo `123` auditando recursos vivos, cargando evidencia operativa AEAT directa si procede y verificando local + VPS sin tocar el trabajo pendiente del `190`.
