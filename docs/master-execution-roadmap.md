...
- 2026-05-18 20:37 Europe/Madrid - `[EN CURSO LOCAL]` Sprint I RTS 1/RTS 2 MiFIR en rama `feat/sprint-i-rts1-rts2`. I-01..I-05 completados. Docker Desktop reparado por ACL de VM en `D:\Docker\DockerDesktopWSL\main\ext4.vhdx`. RTS 1 `32017R0587`, RTS 2 `32017R0583` y prerequisito local MiFIR `32014R0600` cargados en `norma`. Obligaciones RTS 1/2 condicionadas SI cargadas en `sociedad_valores`, `agencia_valores` y `entidad_credito`; notas de pre-negociacion enriquecidas con waivers RTS 1/2; registro ESMA SI `ESMA_REGISTERS_MIF_SI` cargado como `documento_interpretativo` y enlazado como fuente soporte en `obligacion_fuente` peso 2. Verificaciones I-01..I-05: PASS. Caveat: DB local `deploy` estaba vacia antes del sprint; siguiente paso exacto: I-06, actualizar suites MCP/contract con checks RTS 1/2.
