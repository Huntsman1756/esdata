...
- 2026-05-18 00:00 Europe/Madrid - `[COMPLETADO VPS]` Sprint H H-01 en rama `feat/sprint-h-tool-descriptions`: corregida la procedencia del Modelo 290 FATCA. Evidencia documental BOE: `BOE-A-2014-12328` es LIS; el candidato `BOE-A-2014-8331` no es FATCA; el Acuerdo FATCA Espana-EE.UU. correcto es `BOE-A-2014-6854` y la Orden HAP/1136/2014 que aprueba el Modelo 290 es `BOE-A-2014-6922`. Cambios en produccion via `docker compose exec postgres psql`: `obligacion_perfil` Modelo 290 actualizado en 3 perfiles a `source_url=https://www.boe.es/buscar/act.php?id=BOE-A-2014-6854`, conservando `verified=true`; `modelo_normativa` 290 actualizado a `BOE-A-2014-6854`; `modelo_campana` 2025 actualizado a `BOE-A-2014-6922`. Seeds corregidos en `scripts/seed-modelos-v2.py`, `apps/api/seed-modelos-v2.py` y `scripts/seed-fiscal-modelos.sql`. VerificationCommand H-01 => `PASS`. Siguiente paso exacto: H-02, definir `MCP_TOOL_ROUTING_POLICY` en `apps/api/mcp_catalog.py`.
