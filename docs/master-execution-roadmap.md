...
- 2026-05-25 - `[COMPLETADO LOCAL]` `AEAT-OFFICIAL-SOURCE-AUDIT-02`: auditoria viva con fuentes oficiales AEAT/BOE tras corregir `290`, `172` y `173`. Alcance: `217` modelos AEAT activos, `1116` recursos oficiales exportados, `631` URLs oficiales unicas comprobadas en vivo y `904` recursos oficiales con HTTP `200`; artefactos `docs/aeat-official-source-audit-2026-05-25.md` y `docs/aeat-official-source-audit-2026-05-25.json`. Resultado: no se detectan `P0` de recurso oficial activo roto ni deriva de hash descargable en el alcance comprobado; quedan `20` hallazgos `P1` (`old_active_campaign_with_fields`) en modelos `111`, `113`, `115`, `117`, `122`, `124`, `126`, `128`, `145`, `149`, `151`, `210`, `211`, `213`, `217`, `226`, `231`, `232`, `237`, `282`, mas `106` hallazgos `P3` de campana antigua sin campos/casillas activos. No reclamar "todo AEAT actualizado" hasta remediar o marcar fail-closed esos `20` P1 modelo a modelo contra fuentes oficiales.
