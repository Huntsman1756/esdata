...
- 2026-05-18 23:20 Europe/Madrid - `[EN CURSO]` Sprint J CRS/Modelo 289 en rama `feat/sprint-j-crs-289`. J-01 a J-05 completados. Modelo 289: normativa `4`, instrucciones `5`, reglas inclusion/exclusion `6`, keywords `12`. Calendario fiscal: se anadio ventana enero-mayo 2026 para `campana_id=95` y se conserva la fila existente de limite puntual 2026-06-01. Verificacion J-05: `Keywords 289: 12`, `Calendario enero-mayo 289: 1`, `PASS`. Siguiente paso exacto: J-06 cargar al menos 20 campos XSD CRS/289 en `modelo_casilla`.
