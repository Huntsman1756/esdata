...
- 2026-05-31 - `[EN CURSO LOCAL]` `V2-EURLEX-ESMA-AEAT-SPRINT-01`: abierto por instruccion explicita del usuario para empezar por EUR-Lex/ESMA y AEAT sin relajar el freeze de veracidad. Alcance: ampliar `eurlex_market` con MiFIR review 2024, MiFID II review, MAR, RTS 1 y RTS 2 solo si el parser oficial EUR-Lex devuelve articulos; cargar registros ESMA MiCA no-CASP desde CSV oficiales con tabla trazable separada de CASP; reforzar AEAT 124/126/128 como no afirmables salvo evidencia oficial directa, empezando por regresion explicita para 128. No incluye descarga masiva FIRDS ni promocion de campanas AEAT por inferencia.
