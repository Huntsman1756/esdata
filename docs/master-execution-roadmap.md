...
- 2026-05-18 20:34 Europe/Madrid - `[EN CURSO LOCAL]` Sprint I RTS 1/RTS 2 MiFIR en rama `feat/sprint-i-rts1-rts2`. I-01, I-02 e I-03 completados. Docker Desktop reparado por ACL de VM en `D:\Docker\DockerDesktopWSL\main\ext4.vhdx`. RTS 1 `32017R0587`, RTS 2 `32017R0583` y prerequisito local MiFIR `32014R0600` cargados en `norma`. Obligaciones RTS 1/2 condicionadas SI cargadas en `sociedad_valores`, `agencia_valores` y `entidad_credito` con `verified=true`, `completeness=parcial`, `source_url` EUR-Lex; `entidad_credito` incluye caveat MiFIR art. 1.2. Verificaciones: I-01 `RTS 1+2: 2 PASS`; I-02 `SV RTS1/2: 4 PASS`; I-03 `Profiles with RTS1/2: 3 PASS`. Caveat: DB local `deploy` estaba vacia antes del sprint; siguiente paso exacto: I-04, enriquecer notas de exenciones/waivers sin crear filas nuevas.
