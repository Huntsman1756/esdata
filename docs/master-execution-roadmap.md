...
- 2026-05-20 06:20 Europe/Madrid - `[EN CURSO]` Auditoria stale workers A-04..A-14 en rama `fix/full-audit-stale-workers-20260520`. Baseline consolidado `v1.13.0`: `obligacion_perfil=190/190 verified`, perfiles MiCA `casp` + `emisor_token`, API VPS healthy. P-01..P-03 y A-01..A-03 ya cerrados; `cron-eu-sanctions-weekly` instalado/habilitado en VPS; `docs/worker-db-retry-coverage.md` corregido a 68 workers. PRD activo: `prd.json`; copia canonica: `prd-audit-20260520.json`. Siguiente paso exacto: A-04, smoke test de persistent workers reales derivados de Compose.
